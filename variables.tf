...
variable "aws_access_key" {
  default = "AKIAJRPBFFH7JLW5KWEQ" # Access Key of the user what you created
  description = "the user aws access key"
}

variable "aws_secret_key" {
  default = "XoJKfLoqdg4fhyNujVkYWBKOR52Q7b8q1+COTIko" # Secret Key of the user what you created
